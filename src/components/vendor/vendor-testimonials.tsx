        ...
        {testimonials.map((testimonial, index) => {
          ...
          return (
            ...
            >
              ...
              <blockquote className="mb-6 italic" className="text-gray-900">
                "{testimonial.quote}"
              </blockquote>
              <div className="border-t pt-4" style={{ borderColor: "#E0E0E0" }}>
                <div className="font-semibold" className="text-gray-900">
                  {testimonial.author}
                </div>
                <div className="text-sm" className="text-gray-900">
                  {testimonial.role}
                </div>
                <div className="text-sm" className="text-gray-900">
