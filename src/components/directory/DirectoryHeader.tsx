  ...
  return (
    <section className="mx-auto max-w-7xl px-6 pt-10 pb-6">
      ...
      <div className="mt-4">
        <a
          href="/suggest-vendor"
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border-2 border-[color:var(--card-border)] bg-[color:var(--cream)] text-gray-900 hover:bg-[color:var(--cream)]/90 transition-colors"
        >
