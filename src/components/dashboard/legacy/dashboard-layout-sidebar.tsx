...
import { DashboardSidebar } from "@/components/dashboard/legacy/dashboard-sidebar";
import { DashboardSidebarMobile } from "@/components/dashboard/legacy/dashboard-sidebar-mobile";
