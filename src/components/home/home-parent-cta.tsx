      ...
      <Container>
        <div className="text-center mb-12">
          ...
          <p className="bauhaus-body text-xl text-paper/90 max-w-3xl mx-auto leading-relaxed">
            Join thousands of parents who use Child Actor 101 to discover, save,
            and review trusted professionals for their young performers. Your
            free account unlocks powerful features to help you make the best
            decisions for your child's career.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <Card className="text-center bauhaus-card bg-surface hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-surface leading-relaxed">
                Bookmark acting coaches, photographers, agents, and managers you
                love. Build your personalized network of trusted professionals
                all in one place, accessible anytime from your dashboard.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center bauhaus-card bg-surface hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-surface leading-relaxed">
                Share your honest experiences and help other families make
                informed decisions. Read reviews from parents like you to
                discover which professionals deliver the best results for young
                actors.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center bauhaus-card bg-surface hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              <p className="text-surface leading-relaxed">
                Keep a record of the professionals you've worked with and
                organize your child actor journey. See your review history and
                manage all your favorites from one convenient dashboard.
              </p>
            </CardContent>
          </Card>
        </div>
