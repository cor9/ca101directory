...
export default function FAQPage() {
  return (
    <div className="container max-w-4xl mx-auto px-4 py-12">
      ...
      {/* General Questions */}
      <div className="mb-12">
        <h2 className="bauhaus-heading text-2xl font-bold text-bauhaus-blue mb-6">
          General Questions
        </h2>
        <div className="space-y-4">
          <div className="bauhaus-card bg-surface border border-secondary-denim/20 rounded-lg p-6">
            <h3 className="bauhaus-heading font-bold text-ink mb-2 text-lg">
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <h4 className="bauhaus-heading font-semibold text-ink mb-2">
              Getting Started
            </h4>
          ...
          <Link
            ...
            className="bauhaus-card bg-surface border border-secondary-denim/20 rounded-lg p-4 hover:border-bauhaus-blue transition-colors"
          >
            <h4 className="bauhaus-heading font-semibold text-ink mb-2">Claim Listing</h4>
            <p className="bauhaus-body text-sm text-surface">
