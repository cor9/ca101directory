    ...
    <div className="container max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-bauhaus-blue/20 border-l-4 border-brand-blue rounded-lg p-6 mb-8">
        ...
        <ol className="space-y-3">
          <li className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-[#1E1F23]">Log in to your account</p>
          ...
          <li className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-[#1E1F23]">Go to your dashboard</p>
              <p className="text-sm text-[#1E1F23]">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <Link
                  ...
                  className="text-[#1E1F23] hover:text-[#1E1F23]/80 underline text-sm"
                >
      ...
      <div className="bg-bauhaus-mustard/20  rounded-lg p-6 mb-8">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-[#1E1F23]">
              <p>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-semibold text-[#1E1F23] mb-2">Image Guidelines</h4>
            <p className="text-sm text-[#1E1F23]">
          ...
          <Link
            ...
            className="border border-gray-200 rounded-lg p-4 hover:border-brand-blue transition-colors"
          >
            <h4 className="font-semibold text-[#1E1F23] mb-2">Pricing & Plans</h4>
            <p className="text-sm text-[#1E1F23]">
