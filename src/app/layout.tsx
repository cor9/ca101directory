  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* ✅ GOOGLE ANALYTICS */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-ZKY15F9Z96"
        ...
        <Script id="ga" strategy="afterInteractive">
          {`
            ...
            gtag('js', new Date());
            gtag('config', 'G-ZKY15F9Z96');
          `}
        </Script>

        <meta
          name="impact-site-verification"
          content="72d79363-1a4b-42ec-be63-d24c04b73026"
        />
      ...
      <body
        className={cn(
          "min-h-screen bg-bg text-text-primary antialiased",
