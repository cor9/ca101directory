      ...
      <form onSubmit={onSubmit}>
        <Card className="overflow-hidden">
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormControl>
                        <select
                          {...field}
                          className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-paper focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
          ...
          >
            ...
            <div className="text-sm text-paper flex items-center justify-center sm:justify-start gap-2">
