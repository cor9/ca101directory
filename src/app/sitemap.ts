...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
    ...
    console.log('sitemap, blogCategoryListQueryResult size:', blogCategoryListQueryResult.length);
    ...
    blogCategoryListQueryResult.forEach((blogCategory) => {
        if (blogCategory.slug) {
            ...
            console.warn(`sitemap, blog category slug invalid, id:${blogCategory._id}`);
        }
    });
