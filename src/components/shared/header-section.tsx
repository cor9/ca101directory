...
export function HeaderSection({
  ...
  return (
    ...
    >
      {label ? (
        <LabelComponent className="uppercase tracking-wider text-gradient_blue-orange font-semibold">
          {label}
        </LabelComponent>
      ) : null}
      {title ? (
      ...
      {subtitle ? (
        <SubtitleComponent className="mt-6 px-4 text-balance text-lg text-paper">
          {subtitle}
        </SubtitleComponent>
      ) : null}
    </div>
