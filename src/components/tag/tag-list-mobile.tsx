...
import type { TagListQueryResult } from "@/types";
  ...
  return (
    <Drawer.Root open={open} onClose={closeDrawer}>
      <Drawer.Trigger
        ...
        className="flex items-center w-full p-3 gap-x-2 border-y text-paper/90"
      >
      ...
      <Drawer.Portal>
        <Drawer.Content className="fixed inset-x-0 bottom-0 z-50 mt-24 overflow-hidden rounded-t-[10px] border bg-background">
          ...
          <ul className="mb-14 w-full p-3 text-paper">
            <FilterItemMobile
              title="All"
              href="/tag"
              active={!slug}
