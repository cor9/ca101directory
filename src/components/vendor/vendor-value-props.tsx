  ...
  const valueProps = [
    {
      ...
      description:
        "Connect with parents actively seeking acting professionals for their children",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Showcase your credentials and get verified by our team to build credibility",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Get priority visibility and premium positioning to attract more clients",
    },
  ];
