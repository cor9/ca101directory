    ...
    <div className="container max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-blue-50 border-l-4 border-brand-blue rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-charcoal">Full Control</p>
          ...
          <div className="flex items-start gap-3">
            <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
            <div>
              <p className="font-semibold text-charcoal">Instant Ownership</p>
              <p className="text-sm text-charcoal">
          ...
          <div className="flex items-start gap-3">
            <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
            <div>
              <p className="font-semibold text-charcoal">Premium Features</p>
              <p className="text-sm text-charcoal">
          ...
          <div className="flex items-start gap-3">
            <CheckCircle2 className="w-5 h-5 text-green-500 flex-shrink-0 mt-1" />
            <div>
              <p className="font-semibold text-charcoal">Verified Badge</p>
              <p className="text-sm text-charcoal">
        ...
        <div className="bauhaus-card p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <Link
                href="/search"
                className="inline-block bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold px-6 py-2 rounded-lg transition-colors text-sm"
              >
                Search Directory
              </Link>
            </div>
      ...
      <div className="bg-red-50 border-l-4 border-red-500 rounded-lg p-6 mb-8">
        ...
        <div className="space-y-4">
          <div>
            ...
            <button
              type="button"
              className="text-sm text-brand-blue hover:text-brand-blue/80 underline"
            >
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <h4 className="font-semibold text-charcoal mb-2">Getting Started</h4>
            <p className="text-sm text-charcoal">
