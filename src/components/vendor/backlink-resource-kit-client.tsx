  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="bg-white p-4 rounded-lg shadow-md w-48 h-48 flex items-center justify-center flex-shrink-0">
                ...
                <div className="text-center">
                    ...
                    <div className="text-xs text-gray-500 mt-2">Find us on the Directory</div>
                </div>
            </div>
            <div className="w-full">
                ...
                <p className="text-xs text-muted-foreground mt-2">A high-resolution transparent PNG will be provided.</p>
            </div>
        </div>
      </div>
      ...
      <div className="bg-card rounded-lg p-6 border">
        ...
        <div className="relative">
            <div className="bg-muted p-4 rounded-md text-sm text-foreground">
              {socialCaption}
            </div>
            <Button
                size="sm"
