...
export function BadgeApplicationForm({ userId }: BadgeApplicationFormProps) {
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <Upload className="w-8 h-8 text-paper mx-auto mb-2" />
            ...
            <CardContent className="space-y-4">
              ...
              {application.industry_references.length > 0 && (
                <div className="space-y-2">
                  <h4 className="font-medium">
                    Uploaded References (
                    {application.industry_references.length})
                  </h4>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  ...
                  <ul className="space-y-1 text-sm text-paper">
                    ...
                    <li>
                      • References: {application.industry_references.length}{" "}
                      uploaded
                    </li>
                    <li>
  ...
  return (
    <div className="space-y-6">
      ...
      {showNavigation && (
        <div className="space-y-2">
          <div className="flex justify-between text-sm text-paper">
            <span>
