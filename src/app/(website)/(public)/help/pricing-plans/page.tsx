  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div className="bauhaus-card p-6 flex flex-col">
          <div className="text-center mb-6">
            ...
            <div className="mb-4">
              ...
              <span className="text-charcoal">/forever</span>
            </div>
            <p className="text-sm text-charcoal">Perfect for getting started</p>
          </div>

          <div className="flex-1 space-y-3 mb-6">
            <div className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Basic listing</span>
            </div>
            <div className="flex items-start gap-2">
              <X className="w-5 h-5 text-charcoal flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Profile image</span>
            </div>
            <div className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Contact information</span>
            </div>
            <div className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <div className="flex items-start gap-2">
              <X className="w-5 h-5 text-charcoal flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Gallery images</span>
            </div>
            <div className="flex items-start gap-2">
              <X className="w-5 h-5 text-charcoal flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Priority placement</span>
            </div>
            <div className="flex items-start gap-2">
              <X className="w-5 h-5 text-charcoal flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Social media links</span>
            </div>
          </div>
          ...
          <Link
            href="/submit"
            className="block text-center bg-gray-200 hover:bg-gray-300 text-charcoal font-semibold px-6 py-3 rounded-lg transition-colors"
          >
            Get Started
          </Link>
        </div>
        ...
        <div className="bauhaus-card p-6 flex flex-col">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-charcoal mb-2">Standard</h2>
            <div className="mb-4">
              <span className="text-4xl font-bold text-charcoal">$25</span>
              <span className="text-charcoal">/month</span>
            </div>
            <p className="text-sm text-charcoal">Great for small businesses</p>
          </div>
          ...
          <div className="flex-1 space-y-3 mb-6">
            ...
            <div className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Enhanced visibility</span>
            </div>
            <div className="flex items-start gap-2">
              <X className="w-5 h-5 text-charcoal flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Gallery images</span>
        ...
        <div className="bg-white border-4 border-brand-blue rounded-lg p-6 flex flex-col relative shadow-xl">
          ...
          <div className="text-center mb-6">
            ...
            <div className="mb-4">
              <span className="text-4xl font-bold text-charcoal">$50</span>
              <span className="text-charcoal">/month</span>
            </div>
            <p className="text-sm text-charcoal">Best for growing businesses</p>
          </div>
          ...
          <div className="flex-1 space-y-3 mb-6">
            ...
            <div className="flex items-start gap-2">
              <Check className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
              <span className="text-sm text-charcoal">Enhanced profile</span>
            </div>
          </div>
      ...
      <div className="bg-green-50 border-2 border-green-500 rounded-lg p-8 mb-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto">
          <div className="bg-white rounded-lg p-4">
            <p className="text-sm text-charcoal mb-1">Standard Annual</p>
            <p className="text-2xl font-bold text-charcoal">
              $250<span className="text-sm text-charcoal">/year</span>
            </p>
          ...
          <div className="bg-white rounded-lg p-4 border-2 border-brand-blue">
            <p className="text-sm text-charcoal mb-1">Pro Annual</p>
            <p className="text-2xl font-bold text-charcoal">
              $500<span className="text-sm text-charcoal">/year</span>
            </p>
