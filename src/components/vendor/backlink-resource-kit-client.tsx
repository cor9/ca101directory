  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card rounded-lg p-6 border">
        <h2 className="text-xl font-bold text-paper mb-4">Directory Badge</h2>
        <p className="text-paper mb-6">
          Add this badge to your website's homepage or footer to show families
          you're a trusted part of the Child Actor 101 community.
        </p>
        <div className="flex flex-col sm:flex-row items-center gap-6">
          <div className="bg-white p-4 rounded-lg shadow-md w-48 h-48 flex items-center justify-center flex-shrink-0">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-orange-500 font-semibold tracking-wider">
                APPROVED
              </div>
              <div className="text-xs text-paper mt-2">
                Find us on the Directory
              </div>
            </div>
          </div>
          <div className="w-full">
            ...
            <p className="text-xs text-paper mt-2">
              A high-resolution transparent PNG will be provided.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* 2. HTML Snippet */}
      <div className="bg-card rounded-lg p-6 border">
        <h2 className="text-xl font-bold text-paper mb-2">HTML Snippet</h2>
        <p className="text-paper mb-4">
          Copy and paste this code into your website where you want the badge to
          appear.
        </p>
      ...
      <div className="bg-card rounded-lg p-6 border">
        ...
        <p className="text-paper mb-4">
          Use this pre-written text on your website to announce your inclusion
          in the directory.
        </p>
        <div className="relative">
