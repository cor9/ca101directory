    ...
    <section className="mx-auto max-w-7xl px-6 pt-10 pb-6">
      ...
      <div className="mt-8 bauhaus-grid bauhaus-grid-3">
        {[
          ...
          <div key={s.label} className="bauhaus-card p-6 text-center">
            <div className="bauhaus-heading text-3xl text-bauhaus-orange">
              {s.value}
            </div>
            <div className="bauhaus-body text-sm opacity-80 uppercase tracking-wide">
              {s.label}
            </div>
          </div>
        ))}
