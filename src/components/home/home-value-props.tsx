...
export default function HomeValueProps() {
  return (
    <section className="section-why-families py-16" style={{ background: "#0C1A2B", color: "#FFFDD0" }}>
      <Container>
        <div className="mx-auto mb-12 max-w-3xl text-center">
          <p className="text-sm uppercase tracking-wider" style={{ color: "#EAEAEA" }}>
            Why families choose us
          </p>
          <h2 className="mb-4 text-3xl font-bold md:text-4xl" style={{ color: "#FFFDD0", fontWeight: 700 }}>
          ...
          {homeConfig.valueProps.map((value, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="mb-3 text-xl font-bold" style={{ color: "#0C1A2B", fontWeight: 700 }}>
                  {value.title}
                </h3>
                <p className="text-sm leading-relaxed" style={{ color: "#333", fontSize: "0.95rem" }}>
                  {value.description}
                </p>
              </article>
            );
